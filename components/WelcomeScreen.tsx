      ...
      return (
          <div className="fixed inset-0 bg-[#050505] flex items-center justify-center font-sans text-white bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-black to-black">
              ...
              <div className="max-w-md w-full p-8 relative z-10 flex flex-col items-center animate-in fade-in zoom-in duration-500">
                  ...
                  <p className="text-gray-500 text-sm mb-8 text-center">Enter your callsign to access the production secure terminal.</p>
                  ...
                  <div className="w-full space-y-4">
                      ...
                      <button 
                          ...
                          className="w-full bg-[#f5a623] text-black font-black uppercase py-3.5 rounded-xl hover:bg-[#ffb74d] transition-transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2"
                      >
                  ...
                  <div className="mt-8 text-[10px] text-gray-700 font-mono">
                      SECURE TERMINAL v2.0 • LOCAL STORAGE PERSISTENCE
                  </div>
              </div>
          </div>
      );
          ...
          <div className="h-16 border-b border-[#222] bg-[#0c0c0c] flex items-center justify-between px-8 shrink-0">
              ...
              <div className="flex items-center gap-4">
                  <div className="text-right">
                      <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">OPERATOR</div>
