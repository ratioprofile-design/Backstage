...
const INITIAL_SEQUENCES: SequenceBlock[] = [
  {
    id: 'seq-kings-palace',
    name: "King's Palace (3,000 Yrs Ago)",
    location: "INT. KING'S PALACE — GRAND HALL",
    eraOrPeriod: '3000 B.C. Ancient Dynasty',
    scenes: [1, 18, 48, 49, 50],
    color: '#a855f7', // Royal Violet
    shootDay: 1,
    description: "Ancient palace scenes shot together on Location Stage A. Keeps continuity across non-consecutive scenes 1, 18, 48, 49, 50.",
  },
  {
    id: 'seq-ravine-rescue',
    name: "Ravine & River Rescue",
    location: "EXT. RAVINE & RIVERBED",
    eraOrPeriod: "Present Day (Storm)",
    scenes: [42, 43, 44, 45, 46],
    color: "#06b6d4", // Cyan
    shootDay: 2,
    description: "Physical rescue sequence involving mud splatter and wet suit continuity.",
  },
  {
    id: 'seq-trailhead-base',
    name: "Trailhead Base Camp",
    location: "EXT. TRAILHEAD — UNIT BASE",
    eraOrPeriod: "Present Day (Morning)",
    scenes: [10, 12, 15, 20],
    color: "#10b981", // Emerald
    shootDay: 1,
    description: "Initial meeting scenes with Ranger Cole.",
  },
  {
    id: 'seq-voss-epilogue',
    name: "Voss House Epilogue",
    location: "INT. VOSS HOUSE",
    eraOrPeriod: "Present Day (Post-Rescue)",
    scenes: [65, 80, 95, 100],
    color: "#f59e0b", // Amber
    shootDay: 4,
    description: "Dry oversized sweater epilogue scenes.",
  },
];
...
const INITIAL_LOOKS: ContinuityLook[] = [
  ...
  },
  {
    ...
    targetName: 'Mara Voss',
    lookNumber: 2,
    title: 'Torn Jacket (Fall)',
    fromScene: 42,
    toScene: 44,
    imageUrl: 'https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=300&q=80',
    description: 'Left shoulder tear, gravel scuffs on elbows and knees.',
    special: true,
  ...
  },
  {
    ...
    targetName: 'Mara Voss',
    lookNumber: 3,
    title: 'Muddy Wet Suit',
    fromScene: 45,
    toScene: 64,
    imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80',
    description: 'River silt coverage, soaked fabric, persistent wetness.',
    special: true,
    damageLevel: 'Severe',
    bloodLevel: 'Light Drops',
  },
  {
    id: 'costume-mara-4',
    dept: 'costume',
  ...
  // Costume Cole
  {
    ...
    dept: 'costume',
    rowKey: 'cole',
    targetName: 'Ranger Cole',
    lookNumber: 1,
    title: 'Standard Ranger Uniform',
    fromScene: 1,
    toScene: 100,
    imageUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80',
    description: 'Tan short-sleeve button down with badge, olive trousers, utility belt.',
    special: false,
    damageLevel: 'None',
  },
  ...
  // Costume Reyes
  {
    ...
    dept: 'costume',
    rowKey: 'reyes',
    targetName: 'Deputy Reyes',
    lookNumber: 1,
    title: 'Deputy Uniform + Rain Slicker',
    fromScene: 38,
    toScene: 90,
    imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80',
    description: 'Yellow heavy-duty rain slicker worn over tactical deputy vest.',
    special: true,
    damageLevel: 'None',
  },
  ...
  // Makeup Mara
  {
    ...
    targetName: 'Mara Voss',
    lookNumber: 1,
    title: 'Natural Outdoor Makeup',
    fromScene: 1,
    toScene: 41,
    imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80',
    description: 'Light SPF glow, minimal flush, natural lip balm.',
    special: false,
    damageLevel: 'None',
  },
  {
    ...
    targetName: 'Mara Voss',
    lookNumber: 2,
    title: 'Temple Laceration + Dirt Trails',
    fromScene: 42,
    toScene: 64,
    imageUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=300&q=80',
    description: 'Right temple cut with dried blood trickle, mud smear across left jaw.',
    special: true,
    damageLevel: 'Severe',
    bloodLevel: 'Heavy Stains',
  },
  ...
  // Vehicle Pickup Truck
  {
    ...
    dept: 'vehicle',
    rowKey: 'truck',
    targetName: '1994 Ranger Pickup',
    lookNumber: 1,
    title: 'Clean Red Pickup',
    fromScene: 1,
    toScene: 35,
    imageUrl: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?auto=format&fit=crop&w=300&q=80',
    description: 'Faded red paint, clean truck bed, forest service decal on door.',
    special: false,
    damageLevel: 'None',
  },
  {
    ...
    targetName: '1994 Ranger Pickup',
    lookNumber: 2,
    title: 'Mud Scraped Passenger Door',
    fromScene: 36,
    toScene: 85,
    imageUrl: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=300&q=80',
    description: 'Deep scrape along right bed rail, heavy mud splatter over wheels.',
    special: true,
    damageLevel: 'Moderate',
  },

  // Props Satellite Phone
  {
    id: 'props-satphone-1',
    dept: 'props',
    rowKey: 'satphone',
    targetName: 'Iridium Sat Phone',
    lookNumber: 1,
    title: 'Operational Sat Phone',
    fromScene: 1,
    toScene: 44,
    imageUrl: 'https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?auto=format&fit=crop&w=300&q=80',
    description: 'Black rugged satellite telephone, full battery LED indicator.',
    special: false,
    damageLevel: 'None',
  },
  {
    ...
    targetName: 'Iridium Sat Phone',
    lookNumber: 2,
    title: 'Cracked Screen Sat Phone',
    fromScene: 45,
    toScene: 100,
    imageUrl: 'https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?auto=format&fit=crop&w=300&q=80',
    description: 'Spiderweb glass fracture on LCD, antenna scuffed.',
    special: true,
    damageLevel: 'Moderate',
  },
];
